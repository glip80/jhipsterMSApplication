...
public class JhipsterMsApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterMsApplicationApp.class);

    private final Environment env;

    public JhipsterMsApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterMSApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterMsApplicationApp.class);
